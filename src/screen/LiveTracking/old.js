...
const LiveTracking = (props) => {
  ...
  const openGoogleMap = () => {
    openGoogleMapsDirections(
      coordinates.pickupCoords.latitude,
      coordinates.pickupCoords.longitude,
      coordinates.dropCoords.latitude,
      coordinates.dropCoords.longitude
    );
  };
    ...
    <GestureHandlerRootView>
      <BottomSheetModalProvider>
        ...
        <View style={style.container}>
          ...
          >
            <Marker coordinate={coordinates.dropCoords}>
              <CustomMarker
                headerText={""}
          ...
          <View style={style.bottomContainer}>
            <View style={style.navContainer}>
              <Text style={{ fontSize: 13, color: "#fff" }}>
                Open Google Maps for better navigation !
              </Text>
